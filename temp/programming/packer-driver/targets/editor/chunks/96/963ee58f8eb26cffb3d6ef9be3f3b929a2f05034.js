    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        initLayer(uiRoot) {
          ...
          for (const [layerName, layerType] of layerEntries) {
            (_crd && Fwk === void 0 ? (_reportPossibleCrUseOfFwk({
              error: Error()
            }), Fwk) : Fwk).log.trace(`UIMgr init layer: ${layerName} (${layerType})`);
          }

          const popupEntries = (_crd && enumEntries === void 0 ? (_reportPossibleCrUseOfenumEntries({
            error: Error()
          ...
          for (const [popUpName, popUpType] of popupEntries) {
            (_crd && Fwk === void 0 ? (_reportPossibleCrUseOfFwk({
              error: Error()
