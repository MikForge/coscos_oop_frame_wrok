        ...
        initLayer(uiRoot) {
          ...
          var uiFactories = {
            [(_crd && UIType === void 0 ? (_reportPossibleCrUseOfUIType({
              ...
              var n = new (_crd && LayerUIGameNode === void 0 ? (_reportPossibleCrUseOfLayerUIGameNode({
                error: Error()
            ...
            [(_crd && UIType === void 0 ? (_reportPossibleCrUseOfUIType({
              ...
              var n = new (_crd && LayerUISceneNode === void 0 ? (_reportPossibleCrUseOfLayerUISceneNode({
                error: Error()
            ...
            [(_crd && UIType === void 0 ? (_reportPossibleCrUseOfUIType({
              ...
              var n = new (_crd && LayerUIPopUpNode === void 0 ? (_reportPossibleCrUseOfLayerUIPopUpNode({
                error: Error()
          ...
          for (var [layerName, layerTypeValue] of layerEntries) {
            var _layerType = Number(layerTypeValue); // 从 layerMap 找到对应的 UIType


            var uiType = layerMap[_layerType]; // 使用对应 factory 创建节点，若无则退回到默认 new Node

            var factory = uiFactories[uiType];
            var layerNode = factory ? factory(layerName, _layerType) : new Node(layerName); // 将创建的节点加入 uiRoot
            ...
            console.log("[LayerMgr] Created layer node: " + layerName + " of type " + (_crd && UIType === void 0 ? (_reportPossibleCrUseOfUIType({
              ...
              error: Error()
            }), LayerType) : LayerType)[_layerType] + ")");
          }
        }
